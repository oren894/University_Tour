...
public class Board {
    ...
    private void initBoard(ArrayList<EventCard> chanceDeck) {
        ...
        tiles.add(prop("Malas",                     60_000,  1_000, BROWN));        //  1
        tiles.add(prop("Optics",                    60_000,  1_000, BROWN));        //  2
        tiles.add(prop("Linear Algebra",            60_000,  1_000, BROWN));        //  3
        tiles.add(new EventTile("Chance", chanceDeck));                              //  4
        tiles.add(prop("Calculus 1",               100_000,  2_000, LBLUE));        //  5
        tiles.add(prop("Calculus 2",               100_000,  2_000, LBLUE));        //  6
        tiles.add(prop("Memphis 3",                100_000,  2_000, LBLUE));        //  7
        ...
        tiles.add(prop("Data Structures 1",        140_000,  3_000, PINK));         // 11
        tiles.add(new EventTile("Chance", chanceDeck));                              // 12
        tiles.add(prop("Data Structures 2",        140_000,  3_000, PINK));         // 13
        tiles.add(prop("Automata & Computability", 140_000,  3_000, PINK));         // 14
        tiles.add(prop("Computer Networks",        180_000,  4_000, ORANGE));       // 15
        tiles.add(prop("Intro to Circuits",        180_000,  4_000, ORANGE));       // 16
        tiles.add(prop("Circuit Design",           180_000,  4_000, ORANGE));       // 17
        ...
        tiles.add(prop("Electricity & Magnetism",  220_000,  5_000, RED));          // 20
        tiles.add(new EventTile("Chance", chanceDeck));                              // 21
        tiles.add(prop("Mechanics",                220_000,  5_000, RED));          // 22
        tiles.add(prop("Probability",              220_000,  5_000, RED));          // 23
        tiles.add(prop("Radar Systems",            260_000,  6_000, YELLOW));       // 24
        tiles.add(prop("Thermodynamics",           260_000,  6_000, YELLOW));       // 25
        tiles.add(prop("Algebraic Structures",     260_000,  6_000, YELLOW));       // 26
        ...
        tiles.add(prop("Complex Analysis",         300_000,  7_000, GREEN));        // 29
        tiles.add(new EventTile("Chance", chanceDeck));                              // 30
        tiles.add(prop("Calculus 3",               300_000,  7_000, GREEN));        // 31
        tiles.add(prop("Assembler (x86)",          300_000,  7_000, GREEN));        // 32
        tiles.add(prop("Operating Systems",        380_000,  9_000, DARK_BLUE));    // 33
        tiles.add(prop("OOP",                      380_000,  9_000, DARK_BLUE));    // 34
        tiles.add(prop("Software Engineering",     380_000,  9_000, DARK_BLUE));    // 35
    }
